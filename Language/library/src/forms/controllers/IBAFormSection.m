...
- (id)initWithHeaderTitle:(NSString *)header footerTitle:(NSString *)footer {
	if ((self = [super init])) {
		...
		headerView_ = [self getHeaderView];
		footerView_ = nil;
	}
...
- (UIView *)getHeaderView{
	...
	UILabel *label = [[[UILabel alloc] initWithFrame:CGRectMake(20, 10, headerView.frame.size.width - 20, 22)] autorelease];
